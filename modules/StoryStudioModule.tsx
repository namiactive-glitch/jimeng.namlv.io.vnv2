...
const StoryStudioModule: React.FC = () => {
  ...
  const [durationPerEpisode, setDurationPerEpisode] = useState(() => loadState('story_durationPerEpisode', 12));
            ...
            <div className="luxury-card relative overflow-hidden p-4 md:p-8">
              ...
              <div className="space-y-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                  ...
                  <div>
                    <label className="luxury-label">Giây mỗi tập (Min 12s)</label>
                    <div className="flex items-center bg-[#F9FAFB] border border-[#E5E7EB] rounded-xl overflow-hidden h-[52px] px-4 focus-within:ring-2 focus-within:ring-orange-500/20 focus-within:border-orange-500 transition-all">
                      <input 
                        type="number"
                        value={durationPerEpisode}
                        onChange={(e) => setDurationPerEpisode(parseInt(e.target.value) || 0)}
                        onBlur={() => {
                          if (durationPerEpisode < 12) setDurationPerEpisode(12);
                        }}
                        className="flex-1 bg-transparent border-none text-left focus:ring-0 p-0 text-[#1F2937] font-semibold text-sm"
                      />
                ...
                <div className="flex gap-4">
                  ...
                  {script && (
                    ...
                    >
                      BƯỚC TIẾP THEO <ChevronRight className="w-5 h-5" />
                    </button>
                  )}
                </div>
              </div>
            ...
            <div className="luxury-card">
              <div className="flex justify-between items-start mb-10">
                ...
                <div className="flex gap-3">
                  <button onClick={() => setStep(1)} className="p-3 hover:bg-slate-100 rounded-xl transition-colors border border-slate-200" title="Back">
                    <ArrowLeft className="w-5 h-5 text-slate-500" />
                  </button>
                  <button onClick={() => setStep(3)} className="p-3 hover:bg-slate-100 rounded-xl transition-colors border border-slate-200" title="Next">
                            ...
                            >
                              {scene.loading ? (
                                ...
                                <>
                                  ...
                                  <span className="text-xs font-bold text-[#4B5563] group-hover:text-[#F97316] uppercase tracking-widest">GENERATE SCENE PROMPT</span>
                                </>
                              )}
                            </button>
                          )}
          ...
          >
            <div className="luxury-card">
              <div className="flex justify-between items-center mb-10">
                <div className="flex items-center gap-4">
                  <button onClick={() => setStep(2)} className="p-3 hover:bg-slate-100 rounded-xl transition-colors border border-slate-200" title="Back">
                    <ArrowLeft className="w-5 h-5 text-slate-500" />
                  </button>
                  <h2 className="text-2xl font-bold text-[#1F2937]">Prompt Summary</h2>
                </div>

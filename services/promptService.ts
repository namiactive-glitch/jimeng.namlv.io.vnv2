...
"5. BẢO TỒN CHI TIẾT SẢN PHẨM (NGHIÊM NGẶT): Giữ nguyên hình dáng, chi tiết sản phẩm, chữ trên sản phẩm, logo sản phẩm. Tuyệt đối không được thay đổi (Strictly maintain product shape, details, text, and logo. Absolutely no changes allowed).\n" +
...
export const generateContinuityEpisode = async (
  ...
  const numScenes = Math.ceil(duration / 12);
...
Thời lượng tập này: ${duration} giây.

        ...
        <div className="bg-orange-50/50 border border-orange-200 p-5 rounded-2xl relative group transition-all hover:border-orange-300">
          <div className="flex justify-between items-center mb-3">
            ...
            <button 
              ...
              className="flex items-center gap-1.5 px-2 py-1 hover:bg-orange-100 rounded-lg transition-colors text-orange-400 hover:text-orange-600"
              title="Copy Tiếng Việt"
            >
              {copied === 'vi' ? (
                <>
                  <Check className="w-3.5 h-3.5 text-green-500" />
                  <span className="text-[10px] font-bold text-green-500">Đã sao chép</span>
                </>
              ) : (
        ...
        <div className="bg-slate-50 border border-slate-200 p-5 rounded-2xl relative group transition-all hover:border-slate-300">
          <div className="flex justify-between items-center mb-3">
            ...
            <button 
              ...
              className="flex items-center gap-1.5 px-2 py-1 hover:bg-slate-200 rounded-lg transition-colors text-slate-400 hover:text-slate-600"
              title="Copy English"
            >
              {copied === 'en' ? (
                <>
        ...
        <div className="bg-orange-50/30 border border-orange-100 p-5 rounded-2xl relative group transition-all hover:border-orange-200">
          <div className="flex justify-between items-center mb-3">
            ...
            <button 
              ...
              className="flex items-center gap-1.5 px-2 py-1 hover:bg-orange-100 rounded-lg transition-colors text-orange-300 hover:text-orange-500"
